...
const OrgCharts = () => {
  ...
  return (
    <>
      <GetChart label="Average BMI" labels={months} data={genBMI} width="80%" height={85} color="128, 94, 219" />
      <GetChart label="Average Weight" labels={months} data={genWeight} width="45%" height={120} color="217, 82, 170" />
      <GetChart label="Average Height" labels={months} data={genHeight} width="45%" height={120} color="242, 138, 78" />
    </>
  );
}
